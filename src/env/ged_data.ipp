...
set_edit_costs_(Options::EditCosts edit_costs, const std::vector<double> & edit_cost_constants) {
	...
	case Options::EditCosts::LETTER:
		if (edit_cost_constants.size() == 4) {
			...
			throw Error("Wrong number of constants for selected edit costs ged::Options::EditCosts::LETTER. Expected: 4 or 0; actual: " + std::to_string(edit_cost_constants.size()) + ".");
		}
		break;
